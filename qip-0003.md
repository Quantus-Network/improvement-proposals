...
Poseidon2 lives [here](https://github.com/Quantus-Network/qp-poseidon). The historical sketch above used a different sponge parameterization than production PoW; see QIP-0013 for the parameters actually deployed (`width = 12`, `rate = 8`, `capacity = 4`). 
