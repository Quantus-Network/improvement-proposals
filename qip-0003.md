...
NOTE: This proposal has been deprecated in favor of QIP-0013
...
Poseidon2 lives [here](https://github.com/Quantus-Network/qp-poseidon). See [QIP-0013](./qip-0013.md) for the parameters actually deployed. 
...
We changed to poseidon2 from SHA2 and SHA3 because we want block header validation to be easy to prove in a zk-circuit and SHA is notoriously inefficient for this. The historical RSA-shortcut sketch above assumed a different sponge layout than production PoW. Deployed Poseidon2 parameters are documented in [QIP-0013](./qip-0013.md) (`width = 12`, `rate = 8`, `capacity = 4` ⇒ ≈128 bits classical capacity security under \(2^{c/2}\)). 
