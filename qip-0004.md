...
1. **qp-libp2p-identity**: Peer identity and authentication using quantum-resistant signatures
2. **qp-libp2p-noise**: Transport layer security using quantum-resistant key exchange
3. **chain/client/network**: Substrate networking layer with PQC support (in-tree)
...
### Substrate network layer (in-tree)

**Substrate Network Layer PQC Support**

- Modified Substrate's networking layer in `chain/client/network` to use post-quantum libp2p components
- Default node key generation switched to Dilithium (`NodeKeyConfig::Dilithium`)
...
```toml
[dependencies]
qp-rusty-crystals-dilithium = { git = "https://github.com/Quantus-Network/qp-rusty-crystals.git" }

[features]
default = ["dilithium"]
dilithium = ["dep:qp-rusty-crystals-dilithium", "dep:zeroize", "dep:sha2", "dep:hkdf", "rand", "peerid"]
```
...
git = "https://github.com/Quantus-Network/qp-libp2p-identity"
features = ["dilithium"]
```
...
The complete implementation is available across:

- **qp-libp2p-identity**: [https://github.com/Quantus-Network/qp-libp2p-identity](https://github.com/Quantus-Network/qp-libp2p-identity)
- **qp-libp2p-noise**: [https://github.com/Quantus-Network/qp-libp2p-noise](https://github.com/Quantus-Network/qp-libp2p-noise)
- **Substrate networking (in-tree)**: [https://github.com/Quantus-Network/chain/tree/main/client/network](https://github.com/Quantus-Network/chain/tree/main/client/network)

The implementation depends on the Dilithium algorithms provided by [qp-rusty-crystals](https://github.com/Quantus-Network/qp-rusty-crystals) and Kyber for noise from [clatter](https://crates.io/crates/clatter)
