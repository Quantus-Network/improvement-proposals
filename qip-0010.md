...
- [`schedule_transfer_with_delay`](https://github.com/Quantus-Network/chain/blob/main/pallets/reversible-transfers/src/lib.rs) — ordinary accounts only; caller-chosen delay (rejected once an account is high-security)
