...
With this blackbox construction, miners can grind on nonces to find a "small enough" digest, where "small enough" is a dynamic difficulty threshold that updates via EMA every block, targeting a specific block time (starting at 12 seconds).
